...
directory = 'src/document_ocr_passport/modify_passport/image_updating_passport/findBD_passport/data_passport/'
# Создать Базу данных
def create_db():
...
def append_data():
    ...
    os.system(f"unzip {directory}RussianCities.zip -d {directory}")
