from modify_passport.image_updating_passport.red_contour_ps import Passport1
from modify_passport.image_updating_passport.Rotating_ps import New_Rotate
