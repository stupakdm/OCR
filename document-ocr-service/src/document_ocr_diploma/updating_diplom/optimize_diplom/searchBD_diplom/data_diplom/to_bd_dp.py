...
from models_dp import Bachelor, Magistr, Speciality, University, Namessurnames, Families, Base
...
directory = 'src/document_ocr_diploma/updating_diplom/optimize_diplom/searchBD_diplom/data_diplom/'
