...
from passport.modify_passport.image_updating_passport.Rotating_ps import show_img
from passport.modify_passport.image_updating_passport.findBD_passport.chooseBD_ps import Search
from passport.modify_passport.image_updating_passport.findBD_passport.correct_word import Doctr
#from passport.Modify_ps.Image_update_ps.red_contour import Passport1
from passport.modify_passport.info_functions_ps import Info_functions, Pytesseract
...
class Passport:
    ...
    def pack_data_to_file(self, data):
        ...
        t = open(
            f"./results_passport/results/file{self.filePath[self.filePath.find('orig') + len('orig'):self.filePath.find('.')]}.txt",
            'w')
